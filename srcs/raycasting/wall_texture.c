...
//     dprintf(2, "%d, %d\n", y, x);
// 	if (game->shader == 1)
// 		res = ft_strjoin((char)game->text[i].texture[y][x], 'FF');
// 	else
// 		res = ft_strjoin((char)game->text[i].texture[y][x], '00');
//    return(res);
// }

// void    print_wall(t_game *game, t_rays *ray, t_text *text, int i, mlx_image_t *img)
// {
// 	float   wall_height;
// 	float   wall_width;
// 	float   y;
